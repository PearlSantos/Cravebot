 ...
 */
public class BitmapWorkerTaskT extends AsyncTask<String, Void, Bitmap> {
...
//        this.res = res;
    ...
    protected Bitmap doInBackground(String ... params) {
        data = params[0];
        Bitmap img;
        img = decodeBitmapFromURL(data, 100, 100);
    ...
    public static class AsyncDrawableT extends BitmapDrawable {
...
//            connection.disconnect();
    ...
    public Bitmap decodeBitmapFromResource(int resId, int width, int height) {
